...
def signal_to_color_with_hpss(signal,
                              sr,
                              melspec_params,
                              mean=None,
                              std=None,
    ...
    melspec = librosa.feature.melspectrogram(
            signal, sr=sr, **melspec_params)
    melspec_h = librosa.feature.melspectrogram(
            signal_h, sr=sr, **melspec_params)
    melspec_p = librosa.feature.melspectrogram(
            signal_p, sr=sr, **melspec_params)
    ...
    # Stack X as [X,X,X]
    X = np.stack([melspec, melspec_h, melspec_p], axis=-1)
...
class SpectrogramDatasetWithHPSS(data.Dataset):
    def __init__(self,
                 df_trn_tp,
                 dir_data,
                 phase,
